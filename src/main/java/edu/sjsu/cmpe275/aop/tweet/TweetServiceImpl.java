...
public class TweetServiceImpl implements TweetService {
	...
	@Override
	public UUID reply(String user, UUID originalMessage, String message) throws IllegalArgumentException, IOException, AccessControlException {
    	System.out.printf("User %s tweeted replied to message %s with message: %s\n", user, originalMessage, message);
		return UUID.randomUUID();
	}

	@Override
    public void follow(String follower, String followee) throws IOException, IllegalArgumentException {
       	System.out.printf("User %s followed user %s \n", follower, followee);
    }

	@Override
	public void block(String user, String follower) throws IOException , IllegalArgumentException{
